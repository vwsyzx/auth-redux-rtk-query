...
const Regis = () => {
    ...
    const [regisFunc, {error, isLoading, isSuccess}] = userApi.useRegisMutation()

    function RegisFunc(emile, password){
        regisFunc({emile, password})
    }
        ...
        <div className='cover-1'>
            <div className='cover-2'>
                ...
                <div className='tools'>
                    ...
                    <button onClick={() => RegisFunc(input1, input2)}>Apply</button>
                </div>
            </div>
